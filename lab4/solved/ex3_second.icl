...
droptake2 :: [Int] -> [Int]
droptake2 x 
| length x >= 4 = (take 2 x ) ++ (drop ((length x) - 2) x)
= []
...
del_firstlast2 x 
| length x >= 2 = drop 1 (take ((length x) - 1) x)
= []
...
//Start = reverse [[1,2,3],[5,6],[],[7,8,9,10]]
